...
5. Run `/digest` when you want filed notes under `wiki/` (also refreshes `wiki/topic-index.md`).
...
- `wiki/topic-index.md` — recall navigation map (auto-maintained by `/digest`)
